...
Workspace AI-provider settings store only versioned encrypted credentials plus a fingerprint. The current schema has no plaintext credential column or rotation response flag.
