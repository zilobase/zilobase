...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        "fixed inset-0 z-50 bg-effect-scrim supports-backdrop-filter:backdrop-blur-xs data-open:animate-in data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0",
        className
      )}
      {...props}
    />
...
function DrawerTitle({
  ...
  return (
    <DrawerPrimitive.Title
      ...
      className={cn(
        "font-heading text-sm font-medium text-content-primary",
        className
      )}
      {...props}
    />
...
function DrawerDescription({
  ...
  return (
    <DrawerPrimitive.Description
      ...
      className={cn("text-xs/relaxed text-content-secondary", className)}
      {...props}
    />
  )
}
