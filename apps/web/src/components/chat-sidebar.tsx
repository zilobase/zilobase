...
export function ChatSidebarTrigger({
  ...
  return (
    <Button
      ...
      className={cn(
        "fixed bottom-4 z-40 h-10 rounded-full border-sidebar-border bg-sidebar px-3 text-sidebar-foreground shadow-lg ring-1 ring-border transition-[right,background-color,color,transform] duration-320 ease-[cubic-bezier(0.16,1,0.3,1)] hover:-translate-y-0.5 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground motion-reduce:transition-none motion-reduce:hover:translate-y-0",
        adjacentSidebarOpen
