...
type ActionType = DatabaseAutomationAction["type"];
...
function defaultOperation(propertyId = "name"): AutomationPropertyOperation {
  return { mode: "set", propertyId, value: { type: "literal", value: "" } };
}

function defaultFilteredTarget(dataSourceId: string, actionId: string): Extract<AutomationEditPagesTarget, { type: "filtered_data_source" }> {
