...
export function MobileActionBar({
  ...
  return (
    <ButtonGroup
      className="fixed left-1/2 z-50 flex -translate-x-1/2 items-center rounded-full border bg-popover p-0.5 text-popover-foreground shadow-lg ring-1 ring-border md:hidden"
