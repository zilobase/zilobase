...
import { getDatabaseFormHeaderSettings } from "./database-form-header-config"
import {
...
} from "./database-form-question-config"
...
function isOptionProperty(property: DatabaseProperty) {
  return ["select", "status", "multi_select"].includes(
    property.property.type,
  )
}

function getFormQuestionDescription(property: DatabaseProperty) {
