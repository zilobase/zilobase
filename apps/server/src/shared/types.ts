...
export type AppBindings = {
  Bindings: {
    ...
    AI_CUSTOM_AGENTS_ENABLED?: string;
    AI_CUSTOM_AGENT_TRIGGERS_ENABLED?: string;
    AI_CUSTOM_AGENT_EXTERNAL_EVENTS_ENABLED?: string;
    AI_CUSTOM_AGENT_EXECUTION_DISABLED?: string;
    AI_MCP_CUSTOM_SERVERS_ENABLED?: string;
    AI_MCP_ENABLED?: string;
    AI_MCP_EXECUTION_DISABLED?: string;
    AI_MCP_EXTERNAL_WRITES_ENABLED?: string;
    AI_PROVIDER_ALLOWED_BASE_URLS?: string;
    AI_PROVIDER_CREDENTIAL_ENCRYPTION_KEY?: string;
    MCP_CLIENT_METADATA_URL?: string;
    MCP_CREDENTIAL_ENCRYPTION_KEYS?: string;
    MCP_FIGMA_CLIENT_ID?: string;
    MCP_FIGMA_CLIENT_SECRET?: string;
    MCP_GITHUB_CLIENT_ID?: string;
    MCP_GITHUB_CLIENT_SECRET?: string;
    MCP_LINEAR_CLIENT_ID?: string;
    MCP_LINEAR_CLIENT_SECRET?: string;
