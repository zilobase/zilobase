...
export function compileDatabaseAutomationDefinition(
  ...
  definition.actions.forEach((action, actionIndex) => {
    ...
    if (action.type === "define_variables") {
      ...
      validateSlackAction(action, actionPath);
    }
    completedActions.add(action.id);
  });

  function validateEditPagesAction(action: Extract<DatabaseAutomationDefinition["actions"][number], { type: "edit_pages" }>, actionPath: Array<string | number>) {
  ...
  function validateNotificationAction(action: Extract<DatabaseAutomationDefinition["actions"][number], { type: "send_notification" }>, actionPath: Array<string | number>) {
  ...
  function validateGmailAction(action: Extract<DatabaseAutomationDefinition["actions"][number], { type: "send_gmail" }>, actionPath: Array<string | number>) {
  ...
  function validateWebhookAction(action: Extract<DatabaseAutomationDefinition["actions"][number], { type: "send_webhook" }>, actionPath: Array<string | number>) {
  ...
  function validateSlackAction(action: Extract<DatabaseAutomationDefinition["actions"][number], { type: "send_slack" }>, actionPath: Array<string | number>) {
