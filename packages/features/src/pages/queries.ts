...
export type Page = {
  ...
  isTeamspace?: boolean
  lastVisitedAt?: string | null
  navigationPlacements?: PageItemPlacement[]
  workspaceId: string
...
export const pagesNavRootQueryKey = (
  workspaceId: string | null | undefined,
...
export const pagePropertiesQueryKey = (
...
export const pageThreadsQueryKey = (
  pageId: string | null | undefined,
) => ["page", pageId ?? "none", "threads"] as const

export const pageAccessQueryKey = (
  pageId: string | null | undefined,
...
export const pageAccessQueryOptions = (
  ...
  queryOptions({
    ...
    queryFn: async ({ signal }) => {
      ...
      try {
        return await apiFetch<PageAccessPayload>(
          `/pages/${pageId}/access`,
          { method: "GET", signal },
        )
      } catch (error) {
...
export const pagePropertiesQueryOptions = (
  ...
  queryOptions({
    ...
    queryFn: async ({ signal }) => {
      ...
      return apiFetch<PagePropertiesPayload>(
...
export const pageThreadsQueryOptions = (
  ...
  queryOptions({
    ...
    queryFn: async ({ signal }) => {
      ...
      return apiFetch<PageThreadsPayload>(
        `/pages/${pageId}/threads`,
        { method: "GET", signal },
      )
    },
  })
